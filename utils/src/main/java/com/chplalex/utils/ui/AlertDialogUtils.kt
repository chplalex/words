...
import com.chplalex.utils.R

fun getStubAlertDialog(context: Context) = getAlertDialog(context, null, null)

fun getAlertDialog(context: Context, title: String?, message: String?): AlertDialog {
    val builder = AlertDialog.Builder(context)
    var finalTitle = context.getString(R.string.dialog_title_stub)
